...
CUDA_VISIBLE_DEVICES=1   python trainVQGAN_OCT2OCTA.py --dataroot /home/eezzchen/OCT2OCTA3M_3D --name transpro_OCT2OCTA_Test  --model TransPro --netG unet_256 --direction AtoB --lambda_A 10 --lambda_C 5 --dataset_mode alignedoct2octa3d --norm batch --pool_size 0 --load_size 304 --input_nc 1 --output_nc 1 --display_port 6031 --gpu_ids 0 --no_flip #nohup   >OCT2OCTA_KD_Baseline.txt
