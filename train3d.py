...
# python train3d.py --dataroot /home/slidm/OCTA/octa-500/OCT2OCTA3M_3D --name transpro_3M_C5 --model TransPro --netG unet_256 --direction AtoB --lambda_A 10 --lambda_C 5 --dataset_mode alignedoct2octa3d --norm batch --pool_size 0 --load_size 304 --input_nc 1 --output_nc 1 --display_port 6031 --gpu_ids 4 --no_flip

# python train3d.py --dataroot /home/slidm/OCTA/octa-500/OCT2OCTA6M_3D --name transpro_6M_C5 --model TransPro --netG unet_256 --direction AtoB --lambda_A 10 --lambda_C 5 --dataset_mode alignedoct2octa3d --norm batch --pool_size 0 --load_size 400 --input_nc 1 --output_nc 1 --display_port 6032 --gpu_ids 2 --no_flip